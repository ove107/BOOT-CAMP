...
public final class EmployeeDatabase_Impl extends EmployeeDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(2) {
      ...
      public void dropAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("DROP TABLE IF EXISTS `Employee_Table`");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        final HashSet<TableInfo.Index> _indicesEmployeeTable = new HashSet<TableInfo.Index>(0);
        final TableInfo _infoEmployeeTable = new TableInfo("Employee_Table", _columnsEmployeeTable, _foreignKeysEmployeeTable, _indicesEmployeeTable);
        final TableInfo _existingEmployeeTable = TableInfo.read(_db, "Employee_Table");
        if (! _infoEmployeeTable.equals(_existingEmployeeTable)) {
          throw new IllegalStateException("Migration didn't properly handle Employee_Table(com.example.room1.Employee).\n"
                  + " Expected:\n" + _infoEmployeeTable + "\n"
  ...
  protected InvalidationTracker createInvalidationTracker() {
    return new InvalidationTracker(this, "Employee_Table");
  }
  ...
  public void clearAllTables() {
    ...
    try {
      ...
      _db.execSQL("DELETE FROM `Employee_Table`");
